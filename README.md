...
#### Variety of resources (unordered)
 ...
 - Player IDs (`m_PlayerID`, `CharaPlayerID.m_id`, etc.) and their associated English character names in [the CotCPort](https://github.com/veganprimate/CotCPort/blob/main/MiscResources/PlayerID_names_CotCPort.txt) and [OT0](https://github.com/veganprimate/CotCPort/blob/main/MiscResources/PlayerID_names_OT0.txt)
...
- **MarvinCx886** for figuring out how to properly implement custom events
