...
2. 点击 Directory -> Selector，将 Octopath Traveler 0 作为新游戏添加；请务必将 UE Version 选择为 `GAME_OctopathTraveler0`，以便自动反序列化（deserialization）DataBase 文件；最后，在 Directory 中选择 Octopath 0 的 `Paks/` 文件夹。  <img width="488" height="348" alt="FModel" src="https://github.com/user-attachments/assets/211ef83b-3427-4526-a75f-2029cd840b72" />
