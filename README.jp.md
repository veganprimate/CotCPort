...
- **本編**および**『大陸の覇者』／『オクトパストラベラー』／『オクトパストラベラーII』由来の追加コンテンツ**の難度を大幅に引き上げる、_任意導入_の**ハードモード版**。詳細は [ハードモード版](https://github.com/veganprimate/CotCPort/blob/main/Resources/HardMode_jp.md) を参照してください。
