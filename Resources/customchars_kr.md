...
7. (선택) `SkillID`와 `SkillAvailID`를 수정해 커스텀 스킬 및 avail을 추가할 수 있습니다. 자세한 내용은 [커스텀 스킬 및 avail 추가 방법](customskills_ko.md)를 참고하세요.
...
10. `/Game/Content/Local/DataBase/Event/VPartychat/EvPChatOth_01`를 편집해, `m_OptAry[0]`에서 새 `PlayerMemberSetID`를 참조하는 커맨드 10029 엔트리를 추가하세요. `m_OptAry[5]`의 1은 필요 없어 보입니다. 또한 [커스텀 퀘스트 및 이벤트 추가 방법](customqsts_ko.md)도 참고하세요.
