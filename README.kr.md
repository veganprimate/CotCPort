...
- **기본 게임**과 **『대륙의 패자』／『옥토패스 트래블러』／『옥토패스 트래블러 II』 기반 추가 콘텐츠**의 난도를 크게 올리는 _선택 설치_ **하드 모드 버전**. 자세한 내용은 [하드 모드 버전](https://github.com/veganprimate/CotCPort/blob/main/Resources/HardMode_kr.md)을 참조하세요.
